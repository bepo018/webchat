 ...
 */
public class ModifyPasswordMailUtil implements Runnable {
	private String email;// 收件人邮箱
	private String code;// 激活码

	// 有参构造
	public ModifyPasswordMailUtil(String email, String code) {
		this.email = email;
		this.code = code;
	}
	...
	public void run() {
		...
		try {
			...
			// 2.4设置邮件内容
			String content = "<p>彩天下验证码！ 有效期30分钟！！</p><p>验证码:"+code+"</p>";
