...
<html>
<head>
    <title>大发彩票激活账号</title>
    <!-- for-mobile-apps -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="keywords" content="大发彩票激活账号"/>
...
<body>
    <div class="activate_style">
            ...
            <div>
                <span>账号激活码已发送至你的邮箱，请注意查收……</span>
                <h5>已激活账号? <a href="${ctx}/user/login">去登陆</a></h5>


            </div>
            <div class="actvate_footer">
                <p>© 2018 大发彩票激活账号. All rights reserved | Design by <a href="http://chatcai.com">chatcai.com</a></p>
            </div>
