            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="example-navbar-collapse">
                    <ul class="nav navbar-nav fontCol">
                        ...
                        <li>
                            <a id="addIframe" href="http://x781111.com/register?id=94649462" target="myFrameName" class="btn btnReg btn-lg btn-block" >在线投注</a>
                        </li>
                        <li>
                ...
                <div class="col-xs-12 col-md-3 hidden-sm hidden-xs LfBg">
                    ...
                    <div class="navLf-info">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="http://m.x781111.com/service" target="mServiceFrame">
                                    <img src="${ctx}/static/images/def-hd.gif" alt="">
                                    <span>注册、优惠咨</span>
                                </a>
                            </li>
                            <li>
                                <a href="http://m.x781111/service" target="mServiceFrame">
                                    <img src="${ctx}/static/images/def-hd.gif" alt="">
                                    <span>投注、兑奖咨询</span>
                                </a>
                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-sm-5 hidden-xs bdRt">
                            <div class="bdRt-hd">
                                <ul>
                                    <li id="addmIframe">
                                        <a href="http://m.x781111.com" target="mFrame">
