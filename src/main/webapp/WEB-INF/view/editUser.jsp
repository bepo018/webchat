        ...
        <div class="agile-info_w3ls hvr-buzz-out" style="width: 49%;">
            <div class="agile-info_w3ls_grid">
                ...
                <form id="form_register" action="" method="post">
                    ...
                    <span>密码：</span><input type="password" id="pwd" name="password" required=" "
                                           value="${user.password}">
                    <span>手机：</span><input type="text" id="phone" name="phone" required=" " style="margin: 1.5em 0;"
                                           value="${user.phone}">
                    ...
                    <span>等级：</span><input class="browsers" list="browsers" type="text" id="level" name="level"
                                           required=" " value="${user.level}">
