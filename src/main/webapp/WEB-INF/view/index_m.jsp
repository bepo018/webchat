            ...
            <div class="wordCarousel">
                ...
                <div>
                    <marquee behavior="scroll" direction="left" scrollamount="5" <%--onmouseover="this.start()"--%>>
                        <%--20181215star增加跳转--%>
                        <a href="https://x781111.com/register?id=94649462" class="jump">温馨提示：欢迎光临彩天下，点击优惠活动查询领取，祝你游戏愉快</a>
                    </marquee>
                </div>
            </div>
            <!-- 开奖播报 -->
    ...
    $(function () {
        ...
        // //console.log(ua)
         if(ua.indexOf("android")!=-1){
             ...
             repage+='<iframe id="myframe" src="https://x781111.com?_='+(new Date()).getTime()+'" frameborder="0"  scrolling="auto" style="height:'+a+'px"></iframe>'
            ...
            var a=window.screen.height+100;
             ...
             repage+='<object data="https://m.111ctx.com"  id="betpageLoad">'+
                 '<embed src="https://x781111.com" id="betpageLoad2"></embed>'+
                 '</object>'
